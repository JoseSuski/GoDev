...
public class Menu extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (this.listaEspacoCafe.size() == 0){
            JOptionPane.showMessageDialog(null, "Você deve cadastrar um café antes.");
            return;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.listaSalasEvento.size() < 2 && this.listaEspacoCafe.size() < 2){
            JOptionPane.showMessageDialog(null, "Você deve cadastrar duas salas de eventos de 2 cafés antes.");
            return;
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (this.listaSalasEvento.size() == 0){
            JOptionPane.showMessageDialog(null, "Você deve cadastrar uma sala de evento antes.");
            return;
        }
